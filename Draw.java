...
{ 
    ...
    private JFrame j = new JFrame("iDraw v.1.8.2.0");
...
//                                    
    ...
    public Draw() {
        ...
        q13.setBounds(0,590,193,20);
        q14.setBounds(0,610,193,20);
        q15.setBounds(0,630,193,20);
        q16.setBounds(0,650,193,20);
        q17.setBounds(0,670,193,20);
        q18.setBounds(0,690,193,20);
        q17.setBounds(0,670,193,20);
        q18.setBounds(0,690,193,20);
        q19.setBounds(0,710,193,20);
        q20.setBounds(0,730,193,20);
        j.add(q1);
        j.add(q2);
        j.add(q3);
        j.add(q4);
            ...
            public void run() {
                try {
                    while(true) {
                        ...
                        v2 = r.nextInt(256);
                        v3 = r.nextInt(256);
                        Color c13 = new Color(v1,v2,v3);                    
                        v1 = r.nextInt(256);
                        v2 = r.nextInt(256);
                        v3 = r.nextInt(256);
                        Color c14 = new Color(v1,v2,v3);                    
                        v1 = r.nextInt(256);
                        v2 = r.nextInt(256);
                        v3 = r.nextInt(256);
                        Color c15 = new Color(v1,v2,v3);                    
                        v1 = r.nextInt(256);
                        v2 = r.nextInt(256);
                        v3 = r.nextInt(256);
                        Color c16 = new Color(v1,v2,v3);                    
                        v1 = r.nextInt(256);
                        v2 = r.nextInt(256);
                        v3 = r.nextInt(256);
                        Color c17 = new Color(v1,v2,v3);                    
                        v1 = r.nextInt(256);
                        v2 = r.nextInt(256);
                        v3 = r.nextInt(256);
                        Color c18 = new Color(v1,v2,v3);                    
                        v1 = r.nextInt(256);
                        v2 = r.nextInt(256);
                        v3 = r.nextInt(256);
                        Color c19 = new Color(v1,v2,v3);                    
                        v1 = r.nextInt(256);
                        v2 = r.nextInt(256);
                        v3 = r.nextInt(256);
                        Color c20 = new Color(v1,v2,v3);                    
                        q1.setBackground(c1);
                        q2.setBackground(c2);
                        q3.setBackground(c3);
                        q4.setBackground(c4);
                        ...
                        q13.setBackground(c13);
                        q14.setBackground(c14);
                        q15.setBackground(c15);
                        q16.setBackground(c16);
                        q17.setBackground(c17);
                        q18.setBackground(c18);
                        q19.setBackground(c19);
                        q20.setBackground(c20);
                    }
                } catch(Exception e) {
                    e.printStackTrace();
                }
        ...
        JMenuItem filla = new JMenuItem("filla");
        image.add(filla);
        filla.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                option = "filla";
            }
        ...
        q.add(title);
        JLabel title2 = new JLabel("v.1.8.2.0");
